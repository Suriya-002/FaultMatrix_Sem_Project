      ...
      <div className="flex h-screen bg-slate-900">
        ...
        <aside className="w-64 bg-slate-800 border-r border-slate-700 flex flex-col">
          ...
          <nav className="flex-1 p-4 space-y-2">
            ...
            <NavLink to="/devices" icon={<Database size={20} />} label="Devices" />`n            <NavLink to="/patterns" icon={<Sparkles size={20} />} label="Pattern Discovery" />`n            <NavLink to="/patterns" icon={<Sparkles size={20} />} label="Pattern Discovery" />
